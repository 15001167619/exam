...
public class SendMassage {
    ...
    public static void init(String accessKeyId, String accessKeySecret, String signName, String identifyingTempleteCode,
        ...
        SendMassage.accessKeyId = accessKeyId;

        SendMassage.accessKeySecret = accessKeySecret;

        SendMassage.signName = signName;

        SendMassage.identifyingTempleteCode = identifyingTempleteCode;

        SendMassage.registTempleteCode = registTempleteCode;
    ...
    public static void main(String[] args) {
        ...
        SendMassage.init("key", "keysecret", "沉默王二", "SMS_110",

                "SMS_112");

        // 发短信

        SendSmsResponse response = SendMassage.sendIdentifyingCode("手机号", "123456");
        ...
        response = SendMassage.sendNewUserNotice("18637903705", "123456", "4512");
