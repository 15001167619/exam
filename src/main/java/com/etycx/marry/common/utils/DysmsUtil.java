...
public class DysmsUtil {
    ...
    public static int sendSMS(String phone, String code) {
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI35mB6QaDewge";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "cMFXuveoU8YL48DlZJ4ovMzYvaZrkk";//你的accessKeySecret，参考本文档步骤2
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("久禧结婚");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_144195716");
    ...
    public static void main(String[] args) {
        int i = DysmsUtil.sendSMS("18801038095", "123456");
