...
public class Const {
    ...
    public enum LoginStatusEnum{
        ...
        UPDATE_PHONE_SUCCESS(10005,"修改手机号成功"),
        OLD_WRONG_PASS(10006,"原密码错误"),
        DISACCORD_PASS(10007,"两次密码不一致"),
        UPDATE_PASSWORD_SUCCESS(10008,"修改密码成功"),
        WRONG_PHONE(10009,"该手机号已被注册");
    ...
    public enum RegisterStatusEnum{
        ...
        WRONG_PASS(10002,"两次密码不一致"),
        WRONG_VERIFICATION_CODE(10004,"验证码错误"),
        WRONG_PHONE(10005,"手机号已被注册");

        RegisterStatusEnum(int code,String value){
            this.code = code;
            this.value = value;
        }
        ...
        public static RegisterStatusEnum codeOf(int code){
            for(RegisterStatusEnum registerStatusEnum : values()){
                if(registerStatusEnum.getCode() == code){
