package com.etycx.marry.modules.baidu.ueditor;
...
public class PathFormat {
	...
	private static final String SECOND = "StrategyDao";
	...
	private static String getSecond () {
		return new SimpleDateFormat( "StrategyDao" ).format( PathFormat.currentDate );
	}
