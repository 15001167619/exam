package com.etycx.marry.remote.redis.impl;

import com.etycx.marry.common.config.PassportRedis;
import com.etycx.marry.common.utils.SerializeUtil;
...
public class CoreRedisServiceImpl implements ICoreRedisService {
    ...
    @Override
    public void addObjectData(String key, Object value ,int expire) {
        if(value==null)
            return;
        JedisPool pool = PassportRedis.getPool();
        Jedis jedis = null;
