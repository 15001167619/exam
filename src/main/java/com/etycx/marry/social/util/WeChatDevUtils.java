package com.etycx.marry.social.util;
...
public class WeChatDevUtils {
	...
	public static final String SOCIAL_LOGIN_CLIENT_ID = Global.getConfig(Constans.WX.SOCIAL_LOGIN_CLIENT_ID);
	public static final String SOCIAL_LOGIN_CLIENT_SERCRET = Global.getConfig(Constans.WX.SOCIAL_LOGIN_CLIENT_SERCRET);
