...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/banner/marryBanner/">轮播图列表</a></li>
		<shiro:hasPermission name="banner:marryBanner:edit"><li><a href="${ctx}/banner/marryBanner/form?sort=0">轮播图添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="marryBanner" action="${ctx}/banner/marryBanner/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>排序</th>
				<th>添加时间</th>
				<shiro:hasPermission name="banner:marryBanner:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
