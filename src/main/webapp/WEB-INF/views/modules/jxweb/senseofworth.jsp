...
<html>
	<head>
		<meta charset="UTF-8">
		<title>价值观</title>
		<link rel="stylesheet" type="text/css" href="jxweb/jx/css/senseofworth.css">
	...
	<%@ include file="common/header.jsp"%>
		...
		<section class="banner-wrapper">
			<div class="banner-son">
				<img src="${company.worthPic}" alt="" width="1920" height="500">
			</div>
		</section>
		<!-- 导航位置 -->
		<section class="Navigation">
			<a href="index">首页</a>><a href="">价值观</a>
		</section>
		<!-- 分类 -->
		<section class="list-wrapper">
			<div class="ul-1">
				...
				<a href="senseofworth" class="li active">
		...
		<section class="content">
			<div class="common-title-wrapper">
				<h2 class="t-1">价值观</h2>
				<div class="t-2">VALUE</div>
				<div class="t-3"></div>
			</div>
			<div class="li-2">
				<img src="/marry/jxweb/jx/img/201901111529.jpg" alt="" width="1200" height="624">
			</div>
		</section>
