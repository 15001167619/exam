...
<html>
	<head>
		<meta charset="UTF-8">
		<title>公司介绍</title>
		<link rel="stylesheet" type="text/css" href="jxweb/jx/css/aboutenterprises.css">
	...
	<%@ include file="common/header.jsp"%>
		...
		<section class="banner-wrapper">
			<div class="banner-son">
				<img src="${company.mainPic}" alt="" width="1920" height="500">
			</div>
		</section>
		<!-- 导航位置 -->
		<section class="Navigation">
			<a href="index">首页</a>><a href="">公司介绍</a>
		</section>
		<!-- 分类 -->
		<section class="list-wrapper">
			<div class="ul-1">
				<a href="aboutenterprises" class="li active">
		...
		<section class="content">
			<div class="common-title-wrapper">
				<h2 class="t-1">公司介绍</h2>
				<div class="t-2">COMPANY PROFILE</div>
				<div class="t-3"></div>
			</div>
			<div class="li-2">
