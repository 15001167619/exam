...
<head>
    <meta charset="UTF-8">
    <title>手机状态码登录</title>
    <link rel="stylesheet" href="/marry/jxweb/jx/css/loginphone.css">
    <script src="/marry/jxweb/jx/js/jquery.min.js"></script>
    <script src="/marry/jxweb/jx/js/loginphone.js"></script>
</head>
<body>
<!-- 头部开始-->
        ...
        <div class="section_login_con">
            <div class="section_login_con_top">
                ...
                <div class="message">
                    ...
                    <div class="obtain">获取短信验证码</div>
                    <div class="mask"></div>
                </div>
                <div class="err-info"></div>
                <div class="loginup">
                    <input type="button" value="登录" name="loginup" readonly class="loginup-button">
                    <p>
