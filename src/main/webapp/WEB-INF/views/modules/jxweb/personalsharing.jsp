...
<head>
    ...
    <link rel="stylesheet" href="jxweb/jx/css/personalsharing.css">
...
<section class="Navigation">
    <a href="index.html">首页</a>><a href="javascript:;">个人中心</a>><a href="javascript:;">个人分享</a>
</section>
<!-- 内容开始 -->
                            ...
                            <div class="c-1-1">
                                ...
                                <div class="focus">
                                    ...
                                    <a href="javascript:;" class="not">
                                        ...
                                        <i class="iconfont icon-xin"></i><span onclick="followOnclick(${product.businessId})">${product.followName}</span></a><a href="javascript:;" class="share"><i class="iconfont icon-fenxiang"></i>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for(var i =0 ;i<data.productList.length; i++){
                    ...
                    var focusStr = '<a href="javascript:;" class="already">';
                    var isFollow = proInfo.isFollow;
                    if(isFollow == 0){
                        focusStr = '<a href="javascript:;" class="not">';
                    }
                    var str2 ='<div class="focus">'+focusStr+'<i class="iconfont icon-xin"></i><span onclick="followOnclick('+proInfo.businessId+')">'+proInfo.followName+'</span></a><a href="javascript:;" class="share"><i class="iconfont icon-fenxiang"></i><span  onclick="shareOnclick('+proInfo.businessId+')">分享</span>';
    ...
    function followOnclick(businessId) {
        ...
        if(userId ==''){
            ...
            $.ajax({
                ...
                success : function(data) {
                    window.location.href = "personalsharing";
                }
            });
        }
